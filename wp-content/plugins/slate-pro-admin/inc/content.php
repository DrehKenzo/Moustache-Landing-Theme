...
<div class="wrap slate-settings">
	...
	if ( in_array( $slate_pro_license['licenseStatus'], $statuses ) ) {
		...
		<div class="slate-error">
			<h4><?php esc_html_e( 'It looks like you’re using', 'slate-pro' ); ?> Slate Pro <?php esc_html_e( 'without a license.', 'slate-pro' ); ?></h4>
			<p><?php esc_html_e( 'If you like', 'slate-pro' ); ?> Slate Pro <?php esc_html_e( 'please consider', 'slate-pro' ); ?> <a href="admin.php?page=slate_pro_license"><?php esc_html_e( 'entering a license key', 'slate-pro' ); ?></a> <?php esc_html_e( 'to help support us and continue its development. You’ll also receive free updates and technical support!', 'slate-pro' ); ?> <a href="http://sevenbold.com/wordpress/slate-pro/" target="_blank"><?php esc_html_e( 'Visit', 'slate-pro' ); ?> Seven Bold <?php esc_html_e( 'for purchasing information.', 'slate-pro' ); ?></a></p>
		</div>
		<?php }
	} ?>
	...
	<form method="post" action="<?php if ( is_multisite() && is_plugin_active_for_network( 'slate-pro-admin/slate-pro-admin.php' ) ) { ?>edit.php?action=slate_pro_network<?php } else { ?>options.php<?php } ?>">
		...
		<div id="slate__colorSchemes" class="pageSection <?php if ( 'slate_pro_color_schemes' !== $page ) { echo 'hide'; } ?>">
			...
			<h2><?php esc_html_e( 'Color Schemes', 'slate-pro' ); ?></h2>

			<section class="premadeColors">
				<div class="colorDefault">
					<label <?php if ( 'default' == $slate_pro_settings['colorScheme'] ) { ?> class="selected"<?php } ?>>
						<input type="radio" name="slate_pro_settings[colorScheme]" value="default" <?php if ( 'default' == $slate_pro_settings['colorScheme'] ) { ?> checked="checked"<?php } ?>> <?php esc_html_e( 'Default', 'slate-pro' ); ?>
				...
				<div class="colorLight">
					<label <?php if ( 'light' == $slate_pro_settings['colorScheme'] ) { ?> class="selected"<?php } ?>>
						<input type="radio" name="slate_pro_settings[colorScheme]" value="light" <?php if ( 'light' == $slate_pro_settings['colorScheme'] ) { ?> checked="checked"<?php } ?>> <?php esc_html_e( 'Light', 'slate-pro' ); ?>
				...
				<div class="colorBlue">
					<label <?php if ( 'blue' == $slate_pro_settings['colorScheme'] ) { ?> class="selected"<?php } ?>>
						<input type="radio" name="slate_pro_settings[colorScheme]" value="blue" <?php if ( 'blue' == $slate_pro_settings['colorScheme'] ) { ?> checked="checked"<?php } ?>> <?php esc_html_e( 'Blue', 'slate-pro' ); ?>
				...
				<div class="colorCoffee">
					<label <?php if ( 'coffee' == $slate_pro_settings['colorScheme'] ) { ?> class="selected"<?php } ?>>
						<input type="radio" name="slate_pro_settings[colorScheme]" value="coffee" <?php if ( 'coffee' == $slate_pro_settings['colorScheme'] ) { ?> checked="checked"<?php } ?>> <?php esc_html_e( 'Coffee', 'slate-pro' ); ?>
				...
				<div class="colorEctoplasm">
					<label <?php if ( 'ectoplasm' == $slate_pro_settings['colorScheme'] ) { ?> class="selected"<?php } ?>>
						<input type="radio" name="slate_pro_settings[colorScheme]" value="ectoplasm" <?php if ( 'ectoplasm' == $slate_pro_settings['colorScheme'] ) { ?> checked="checked"<?php } ?>> <?php esc_html_e( 'Ectoplasm', 'slate-pro' ); ?>
				...
				<div class="colorMidnight">
					<label <?php if ( 'midnight' == $slate_pro_settings['colorScheme'] ) { ?> class="selected"<?php } ?>>
						<input type="radio" name="slate_pro_settings[colorScheme]" value="midnight" <?php if ( 'midnight' == $slate_pro_settings['colorScheme'] ) { ?> checked="checked"<?php } ?>> <?php esc_html_e( 'Midnight', 'slate-pro' ); ?>
				...
				<div class="colorOcean">
					<label <?php if ( 'ocean' == $slate_pro_settings['colorScheme'] ) { ?> class="selected"<?php } ?>>
						<input type="radio" name="slate_pro_settings[colorScheme]" value="ocean" <?php if ( 'ocean' == $slate_pro_settings['colorScheme'] ) { ?> checked="checked"<?php } ?>> <?php esc_html_e( 'Ocean', 'slate-pro' ); ?>
				...
				<div class="colorSunrise">
					<label <?php if ( 'sunrise' == $slate_pro_settings['colorScheme'] ) { ?> class="selected"<?php } ?>>
						<input type="radio" name="slate_pro_settings[colorScheme]" value="sunrise" <?php if ( 'sunrise' == $slate_pro_settings['colorScheme'] ) { ?> checked="checked"<?php } ?>> <?php esc_html_e( 'Sunrise', 'slate-pro' ); ?>
				...
				<div class="colorCustom">
					<label <?php if ( 'custom' == $slate_pro_settings['colorScheme'] ) { ?> class="selected"<?php } ?>>
						<input type="radio" name="slate_pro_settings[colorScheme]" value="custom" <?php if ( 'custom' == $slate_pro_settings['colorScheme'] ) { ?> checked="checked"<?php } ?>> <?php esc_html_e( 'Custom', 'slate-pro' ); ?>
			...
			<!-- Color Nav -->
			<div class="colorNav">
				<h3><?php esc_html_e( 'Custom Color Options', 'slate-pro' ); ?></h3>
				<ul>
					<li class="loginPageColors"><a class="nav-tab selected" href="#"><?php esc_html_e( 'Login Page', 'slate-pro' ); ?></a></li>
					<li class="adminMenuColors"><a class="nav-tab" href="#"><?php esc_html_e( 'Admin Menu', 'slate-pro' ); ?></a></li>
					<li class="adminBarColors"><a class="nav-tab" href="#"><?php esc_html_e( 'Admin Bar', 'slate-pro' ); ?></a></li>
					<li class="adminFooterColors"><a class="nav-tab" href="#"><?php esc_html_e( 'Admin Footer', 'slate-pro' ); ?></a></li>
					<li class="adminContentColors"><a class="nav-tab" href="#"><?php esc_html_e( 'Content', 'slate-pro' ); ?></a></li>
					<li class="adminSidebarColors"><a class="nav-tab" href="#"><?php esc_html_e( 'Sidebar/Sortables', 'slate-pro' ); ?></a></li>
				</ul>
			</div>
			<!-- Login Page -->
				...
				<ul>
					<li>
						<label>
							...
							<?php esc_html_e( 'Hide “Admin Color Scheme” Options on User Profile Pages', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'Hide Admin Menu and Sidebar Shadows', 'slate-pro' ); ?>
						</label>
					</li>
				</ul>
			</section>
		...
		<div id="slate__branding" class="pageSection <?php if ( 'slate_pro_branding' !== $page ) { echo 'hide'; } ?>">
			<h2><?php esc_html_e( 'Branding', 'slate-pro' ); ?></h2>

			<section>
				<h3><?php esc_html_e( 'Login Page Logo Link Title and Address', 'slate-pro' ); ?></h3>
				<ul>
					<li>
						<label><?php esc_html_e( 'Link Title', 'slate-pro' ); ?> <input type="text" name="slate_pro_settings[loginLinkTitle]" value="<?php echo esc_attr( $loginLinkTitle ); ?>"></label>
					</li>
					<li>
						<label><?php esc_html_e( 'Link Address', 'slate-pro' ); ?> <input type="text" name="slate_pro_settings[loginLinkUrl]" value="<?php echo esc_attr( $loginLinkUrl ); ?>"></label>
					</li>
				</ul>
			</section>

			<section>
				<h3><?php esc_html_e( 'Login Page Logo', 'slate-pro' ); ?></h3>
				<ul>
					<li>
					...
					<li class="slate__selectLoginLogo">
						<a href="#" class="button imageSelect"><?php esc_html_e( 'Select Image', 'slate-pro' ); ?></a>
						<a href="#" class="imageDelete" <?php echo wp_kses_post( $loginLogoDelete ); ?>><?php esc_html_e( 'Delete Image', 'slate-pro' ); ?></a>
					</li>
					<li class="slate__description">
						<?php esc_html_e( 'Make sure the image is no greater than 320 pixels wide by 80 pixels high.', 'slate-pro' ); ?>
					</li>
					<li>
						<label>
							<input name="slate_pro_settings[loginLogoHide]" type="checkbox" <?php checked( esc_attr( $slate_pro_settings['loginLogoHide'] ), 'on' ); ?>>
							<?php esc_html_e( 'Hide the Login Logo', 'slate-pro' ); ?>
						</label>
					</li>
				</ul>
			</section>
			...
			<section>
				<h3><?php esc_html_e( 'Login Page Background Image', 'slate-pro' ); ?></h3>
				<ul>
					<li>
					...
					<li class="slate__selectLoginBg">
						<a href="#" class="button imageSelect"><?php esc_html_e( 'Select Image', 'slate-pro' ); ?></a>
						<a href="#" class="imageDelete" <?php echo wp_kses_post( $loginBgImageDelete ); ?>><?php esc_html_e( 'Delete Image', 'slate-pro' ); ?></a>
					</li>
					<li>
						<!-- <p class="slate__description"><?php esc_html_e( 'Your logo should be no larger than 320px by 80px or else it will be resized on the login screen.', 'slate-pro' ); ?></p> -->
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'Background Position', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
			...
			<section>
				<h3><?php esc_html_e( 'Full Width Menu Logo', 'slate-pro' ); ?></h3>
				<ul>
					<li>
					...
					<li class="slate__selectAdminLogo">
						<a href="#" class="button imageSelect"><?php esc_html_e( 'Select Image', 'slate-pro' ); ?></a>
						<a href="#" class="imageDelete" <?php echo wp_kses_post( $adminLogoDelete ); ?>><?php esc_html_e( 'Delete Image', 'slate-pro' ); ?></a>
					</li>
					<li class="slate__description">
						<?php esc_html_e( 'Make sure the image is no wider than 200 pixels. Double it for high resolution.', 'slate-pro' ); ?>
					</li>
				</ul>
			</section>

			<section>
				<h3><?php esc_html_e( 'Collapsed Menu Logo', 'slate-pro' ); ?></h3>
				<ul>
					<li>
					...
					<li class="slate__selectAdminLogoFolded">
						<a href="#" class="button imageSelect"><?php esc_html_e( 'Select Image', 'slate-pro' ); ?></a>
						<a href="#" class="imageDelete" <?php echo wp_kses_post( $adminLogoFoldedDelete ); ?>><?php esc_html_e( 'Delete Image', 'slate-pro' ); ?></a>
					</li>
					<li class="slate__description">
						<?php esc_html_e( 'Make sure the image is no wider than 36 pixels. Double it for high resolution.', 'slate-pro' ); ?>
					</li>
				</ul>
			</section>

			<section>
				<h3><?php esc_html_e( 'Favicon', 'slate-pro' ); ?></h3>
				<ul>
					<li>
					...
					<li class="slate__selectAdminFavicon">
						<a href="#" class="button imageSelect"><?php esc_html_e( 'Select Image', 'slate-pro' ); ?></a>
						<a href="#" class="imageDelete" <?php echo wp_kses_post( $adminFaviconDelete ); ?>><?php esc_html_e( 'Delete Image', 'slate-pro' ); ?></a>
					</li>
					<li class="slate__description">
						<?php esc_html_e( 'Make sure the image exactly 16 pixels high and 16 pixels wide.', 'slate-pro' ); ?>
					</li>
				</ul>
			</section>
			<?php submit_button(); ?>
		...
		<div id="slate__dashboard" class="pageSection <?php if ( 'slate_pro_dashboard' !== $page ) { echo 'hide'; } ?>">
			...
			<h2><?php esc_html_e( 'Dashboard', 'slate-pro' ); ?></h2>

			<section>
				<h3><?php esc_html_e( 'Welcome Message', 'slate-pro' ); ?></h3>
				<ul>
					<li>
						<label>
							...
							<?php esc_html_e( 'Hide the Dashboard Welcome Message', 'slate-pro' ); ?>
						</label>
					</li>
				</ul>
			</section>
			...
			<section>
				<h3><?php esc_html_e( 'Custom Widget', 'slate-pro' ); ?></h3>
				<ul>
					<li>
						<label>
							...
							<?php esc_html_e( 'Show a Custom Widget on the Dashboard', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label><?php esc_html_e( 'Widget Title', 'slate-pro' ); ?> <input type="text" name="slate_pro_settings[dashboardCustomWidgetTitle]" value="<?php echo esc_attr( $dashboardCustomWidgetTitle ); ?>"></label>
					</li>
					<li>
						<label><?php esc_html_e( 'Widget Content (HTML Allowed)', 'slate-pro' ); ?>
			...
			<section>
				<h3><?php esc_html_e( 'Hide Widgets', 'slate-pro' ); ?> <span class="slate__select"><a href="#" class="slate__selectAll"><?php esc_html_e( 'Select All', 'slate-pro' ); ?></a> / <a href="#" class="slate__selectNone"><?php esc_html_e( 'Select None', 'slate-pro' ); ?></a></span></h3>
				<ul>
					<li>
						<label>
							...
							<?php esc_html_e( 'Activity', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'WordPress News', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'At a Glance', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'Recent Comments', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'Quick Press', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'Recent Drafts', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'Incoming Links', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'Plugins', 'slate-pro' ); ?>
						</label>
					</li>
				</ul>
			</section>
		...
		<div id="slate__adminMenu" class="pageSection <?php if ( 'slate_pro_admin_menu' !== $page ) { echo 'hide'; } ?>">
			...
			<h2><?php esc_html_e( 'Admin Menu', 'slate-pro' ); ?></h2>

			<section>
				<h3><?php esc_html_e( 'Hide the following Menu Items', 'slate-pro' ); ?> <span class="slate__select"><a href="#" class="slate__selectAll"><?php esc_html_e( 'Select All', 'slate-pro' ); ?></a> / <a href="#" class="slate__selectNone"><?php esc_html_e( 'Select None', 'slate-pro' ); ?></a></span></h3>
			...
			<section>
				<h3><?php esc_html_e( 'Apply to the following Users', 'slate-pro' ); ?> <span class="slate__select"><a href="#" class="slate__selectAll"><?php esc_html_e( 'Select All', 'slate-pro' ); ?></a> / <a href="#" class="slate__selectNone"><?php esc_html_e( 'Select None', 'slate-pro' ); ?></a></span></h3>
				<?php $users = get_users();
		...
		<div id="slate__adminBar" class="pageSection <?php if ( $page !== 'slate_pro_admin_bar_footer' ) { echo 'hide'; } ?>">
			...
			<section>
				<h3><?php esc_html_e( 'Admin Footer', 'slate-pro' ); ?></h3>
				<ul>
					<li>
						<label>
							<input name="slate_pro_settings[footerTextShow]" type="checkbox" <?php checked( esc_attr( $slate_pro_settings['footerTextShow'] ), 'on' ); ?>>
							<?php esc_html_e( 'Display Custom Footer Text', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label><?php esc_html_e( 'Footer Text (HTML Allowed)', 'slate-pro' ); ?>
		...
		<div id="slate__contentNotices" class="pageSection <?php if ( $page !== 'slate_pro_content_notices' ) { echo 'hide'; } ?>">
			...
			<h2><?php esc_html_e( 'Content &amp; Notices', 'slate-pro' ); ?></h2>

			<section>
				<h3><?php esc_html_e( 'Title', 'slate-pro' ); ?></h3>
				<ul>
					<li>
						<label>
							...
							<?php esc_html_e( 'Hide "WordPress" in Page Titles', 'slate-pro' ); ?>
						</label>
					</li>
				</ul>
			</section>
				...
				<ul>
					...
					<li>
						<label>
							...
							<?php esc_html_e( 'Hide the Screen Options Tab', 'slate-pro' ); ?>
						</label>
					</li>
				</ul>
			</section>
			...
			<section>
				<h3><?php esc_html_e( 'Disable Notices', 'slate-pro' ); ?></h3>
				<p><?php esc_html_e( 'Depending on the number of themes and plugins you have installed, the options below may slow down the WordPress admin. If you’re concerned about speed, see the “Hide Notices” option below.', 'slate-pro' ); ?></p>
				<ul>
					<li>
						<label>
							<input name="slate_pro_settings[noticeWPUpdate]" type="checkbox" <?php checked( esc_attr( $slate_pro_settings['noticeWPUpdate'] ), 'on' ); ?>>
							<?php esc_html_e( 'Disable WordPress Core Update Notices', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'Disable WordPress Theme Update Notices', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label>
							...
							<?php esc_html_e( 'Disable WordPress Plugin Update Notices', 'slate-pro' ); ?>
						</label>
					</li>
				</ul>
			</section>
			...
			<section>
				<h3><?php esc_html_e( 'Hide Notices', 'slate-pro' ); ?></h3>
				<p><?php esc_html_e( 'This is an alternative to completely disabling the notices. This option won’t slow down the admin, but if the user has access to the following pages, they may still see updates are available: /wp-admin/update-core.php, /wp-admin/themes.php, and /wp-admin/plugins.php.', 'slate-pro' ); ?></p>
				<ul>
					<li>
						<label>
							...
							<?php esc_html_e( 'Hide All WordPress Update Notices', 'slate-pro' ); ?>
						</label>
					</li>
				</ul>
			</section>
		...
		<div id="slate__permissions" class="pageSection <?php if ( $page !== 'slate_pro_permissions' ) { echo 'hide'; } ?>">
			...
			<h2><?php esc_html_e( 'Permissions', 'slate-pro' ); ?></h2>
			<section>
				<p><?php esc_html_e( 'Below you can choose which users will see the', 'slate-pro' ); ?> Slate Pro <?php esc_html_e( 'plugin. Keep in mind that if you', 'slate-pro' ); ?> <span style='color: #c00;'><?php esc_html_e( 'check your own name, you’ll no longer be able to access these settings', 'slate-pro' ); ?></span>.<?php esc_html_e( 'If that happens, you’ll need to', 'slate-pro' ); ?> <a href="admin.php?page=slate_pro_permissions"><?php esc_html_e( 'bookmark this page', 'slate-pro' ); ?></a> <?php esc_html_e( 'or deactivate and reactivate the plugin. Make sure to keep an up-to-date', 'slate-pro' ); ?> <a href="admin.php?page=slate_pro_import_export"><?php esc_html_e( 'backup of your settings', 'slate-pro' ); ?></a>. <?php esc_html_e( 'Only users who already have permission to access plugins are shown below.', 'slate-pro' ); ?></p>
			</section>
			<?php
			$users = get_users();
			if ( !($users[0] instanceof WP_User) ) {
			...
			<section>
				<h3><?php esc_html_e( 'Hide', 'slate-pro' ); ?> Slate Pro <?php esc_html_e( 'from the following Users', 'slate-pro' ); ?></h3>
				<ul>
					<?php foreach ($users as $key => $value) {
						$user_role = $users[$key]->roles;
						$user_id = $users[$key]->ID;
		...
		<div id="slate__settings" class="pageSection <?php if ( $page !== 'slate_pro_settings' ) { echo 'hide'; } ?>">
			...
			<h2><?php esc_html_e( 'Settings', 'slate-pro' ); ?></h2>

			<section>
				<h3><?php esc_html_e( 'Custom Login Address', 'slate-pro' ); ?></h3>

				<p><?php esc_html_e( 'If you use a third party plugin that changes the WordPress Login page from /wp-login.php to something else, you may need to enter your custom login page address below so that Slate Pro can work on the Login page.', 'slate-pro' ); ?></p>

				<p><?php esc_html_e( 'The Login Page Address should be what comes after your domain name. If your login page was at http://yourdomain.com/mycustomlogin, you would enter "/mycustomlogin". If it was at http://yourdomain.com/subdirectory/mycustomlogin, you would enter "/subdirectory/mycustomLogincustomlogin".', 'slate-pro' ); ?></p>

				<ul>
					<li>
						<label>
							<input name="slate_pro_settings[customLogin]" type="checkbox" <?php checked( esc_attr( $slate_pro_settings['customLogin'] ), 'on' ); ?>>
							<?php esc_html_e( 'Enable Slate Pro on a Custom Login Page', 'slate-pro' ); ?>
						</label>
					</li>
					<li>
						<label><?php esc_html_e( 'Login Page Address', 'slate-pro' ); ?> <input type="text" name="slate_pro_settings[customLoginURL]" value="<?php echo esc_attr( $customLoginURL ); ?>"></label>
					</li>
				</ul>
			</section>
	...
	<div id="slate__importExport" class="pageSection <?php if ( $page !== 'slate_pro_import_export' ) { echo 'hide'; } ?>">
		<form action="" method="post">
			...
			<h2><?php esc_html_e( 'Import / Export', 'slate-pro' ); ?></h2>

			<section>
				<h3><?php esc_html_e( 'Import', 'slate-pro' ); ?></h3>
				<?php
				global $slate_pro_import_success;
				if ( isset( $slate_pro_import_success ) && true == $slate_pro_import_success ) { ?>
				<!-- <script type="text/javascript">location.reload();</script> -->
				<div class="importSuccess"><?php esc_html_e( 'The Import was Successful!', 'slate-pro' ); ?></div>
				<?php } else if ( isset( $slate_pro_import_success ) && false == $slate_pro_import_success ) { ?>
				<div class="importFail"><?php esc_html_e( 'Oops, the import didn’t work.', 'slate-pro' ); ?></div>
				<?php } ?>
				<textarea class="slateProImportExport" name="slate_pro_import_settings"></textarea>
				<p class="slate__description">
					<?php esc_html_e( 'Paste your settings above and click “Save Changes” to import. It should look like the text in the Export field below.', 'slate-pro' ); ?>
				</p>
			...
			<section>
				<h3><?php esc_html_e( 'Export', 'slate-pro' ); ?></h3>
				<textarea class="slateProImportExport"><?php echo base64_encode( serialize( $slate_pro_settings ) ); ?></textarea>
				<p class="slate__description">
					<?php esc_html_e( 'Copy and save the text above to backup your', 'slate-pro' ); ?> Slate Pro <?php esc_html_e( 'settings.', 'slate-pro' ); ?>
				</p>
			</section>
	...
	<div id="slate__about" class="pageSection <?php if ( $page !== 'slate_pro_about' ) { echo 'hide'; } ?>">
		...
		<h2><?php esc_html_e( 'About', 'slate-pro' ); ?> Slate Pro</h2>
		<section>
			<p><?php esc_html_e( 'If you need product support, please leave a comment on the', 'slate-pro' ); ?> <a href="http://codecanyon.net/item/slate-pro-a-white-label-wordpress-admin-theme/9722528?ref=sevenbold" target="_blank"><?php esc_html_e( 'CodeCanyon product page', 'slate-pro' ); ?></a>. <?php esc_html_e( 'Remember that we’re not able to support third party plugins that might conflict with', 'slate-pro' ); ?> Slate Pro.</p>
		</section>
	...
	<div id="slate__license" class="pageSection <?php if ( $page !== 'slate_pro_license' ) { echo 'hide'; } ?>">
		...
		<form action="" method="post">
			...
			<h2><?php esc_html_e( 'License', 'slate-pro' ); ?></h2>
			<p><?php esc_html_e( 'Enter your license key to qualify for premium customer support, receive updates via the WordPress Plugins page, access future updates, and other added benefits. Your license key is the same as the “Purchase Code” you received in your CodeCanyon.net purchase receipt email.', 'slate-pro' ); ?></p>
			<?php if ( isset($expire_date) && $expire_date > strtotime( $slate_pro_settings['licenseDate'] ) ) { ?>
			<p><?php esc_html_e( 'If you need a license key,', 'slate-pro' ); ?> <a href="http://sevenbold.com/wordpress/slate-pro/" target="_blank"><?php esc_html_e( 'please visit', 'slate-pro' ); ?> Seven Bold <?php esc_html_e( 'for info on how to buy', 'slate-pro' ); ?> Slate Pro</a>.</p>
			<?php } ?>
			<section>
				<ul>
					<li>
						<label><?php esc_html_e( 'License Key', 'slate-pro' ); ?> <input type="text" name="slate_pro_license[licenseKey]" value="<?php if ( 'active' == $licenseState ) { echo esc_attr( $slate_pro_license['licenseKey'] ); } ?>" <?php if ( 'active' == $licenseState ) {?> readonly="readonly"<?php } ?>></label>
						<div class="slate__licenseStatus">
							<?php if ( 'success' == $licenseReply ) { ?>
							<span class="slate__licenseSuccess"><?php esc_html_e( 'Your License Key was successfully activated!', 'slate-pro' ); ?></span>
							<?php	} else if ( 'current' == $licenseReply ) { ?>
							<span class="slate__licenseSuccess"><?php esc_html_e( 'Awesome, your license is valid and active!', 'slate-pro' ); ?></span>
							<?php	} else if ( 'invalid' == $licenseReply ) { ?>
							<span class="slate__licenseInvalid"><?php esc_html_e( 'Shoot, it looks like your License Key isn’t valid.', 'slate-pro' ); ?></span>
							<?php	} else if ( 'used' == $licenseReply ) { ?>
							<span class="slate__licenseActive"><?php esc_html_e( 'Looks like this key is already activated. It needs to be deactivated before you can use it.', 'slate-pro' ); ?></span>
							<?php	} else if ( 'removed' == $licenseReply ) { ?>
							<span class="slate__licenseRemoved"><?php esc_html_e( 'Your license key was successfully removed.', 'slate-pro' ); ?></span>
							<?php	} else if ( 'failed' == $licenseReply ) { ?>
							<span class="slate__licenseFailed"><?php esc_html_e( 'The license key you’re deactivating doesn’t match the website its activated on. Please deactivate from the proper website.', 'slate-pro' ); ?></span>
							<?php	} else if ( 'server' == $licenseReply ) { ?>
							<span class="slate__licenseServer"><?php esc_html_e( 'Oops, we couldn’t connect to the licensing server.', 'slate-pro' ); ?></span>
							<?php } ?>
						</div>
					</li>
...
<h4><?php esc_html_e( $section, 'slate-pro' ); ?></h4>
<ul>
	<?php foreach ( $names as $field => $name ) { ?>
	<?php if ( is_array( $name ) ) { ?>
	<li><h5><?php esc_html_e( $field, 'slate-pro' ); ?></h5></li>
